...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_profile', 'about',
        ...
        # Adding unique constraint on 'UserService', fields ['profile', 'service']
        db.create_unique(u'accounts_userservice', ['profile_id', 'service_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserService', fields ['profile', 'service']
        db.delete_unique(u'accounts_userservice', ['profile_id', 'service_id'])

        # Deleting field 'Profile.location'
        db.delete_column(u'accounts_profile', 'location')

        # Deleting field 'Profile.about'
        db.delete_column(u'accounts_profile', 'about')
    ...
    models = {
        u'accounts.profile': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['services.Service']", 'through': u"orm['accounts.UserService']", 'symmetrical': 'False'}),
            'twitter': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'profile'", 'unique': 'True', 'to': u"orm['auth.User']"}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        u'accounts.userservice': {
            'Meta': {'unique_together': "(('profile', 'service'),)", 'object_name': 'UserService'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'service_detailed'", 'to': u"orm['accounts.Profile']"}),
