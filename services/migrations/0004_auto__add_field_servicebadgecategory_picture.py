...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceBadgeCategory.picture'
        db.add_column(u'services_servicebadgecategory', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServiceBadgeCategory.picture'
        db.delete_column(u'services_servicebadgecategory', 'picture')
