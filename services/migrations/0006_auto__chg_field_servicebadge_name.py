...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceBadge.name'
        db.alter_column(u'services_servicebadge', 'name', self.gf('django.db.models.fields.CharField')(default='unnamed', max_length=20))

    def backwards(self, orm):

        # Changing field 'ServiceBadge.name'
        db.alter_column(u'services_servicebadge', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
